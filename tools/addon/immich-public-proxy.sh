...
# Source: https://gh-proxy.org/https://github.com/alangrainger/immich-public-proxy
...
type=update bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/immich-public-proxy.sh)"
UPDATEEOF
