...
# Source: https://gh-proxy.org/https://github.com/fccview/cronmaster
...
type=update bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/cronmaster.sh)"
EOF
