...
# Source: https://gh-proxy.org/https://github.com/CyferShepard/Jellystat
...
type=update bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/jellystat.sh)"
UPDATEEOF
