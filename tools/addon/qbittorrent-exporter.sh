...
# Source: https://gh-proxy.org/https://github.com/martabal/qbittorrent-exporter
...
source <(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/misc/core.func)
source <(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/misc/tools.func)
source <(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/misc/error_handler.func)
...
function install() {
  ...
  cat <<EOF >"$CONFIG_PATH"
# https://gh-proxy.org/https://github.com/martabal/qbittorrent-exporter?tab=readme-ov-file#parameters
...
type=update bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/qbittorrent-exporter.sh)"
UPDATEEOF
