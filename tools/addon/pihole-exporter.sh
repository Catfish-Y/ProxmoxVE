...
# Source: https://gh-proxy.org/https://github.com/eko/pihole-exporter/
...
function install() {
  ...
  cat <<EOF >"$CONFIG_PATH"
# https://gh-proxy.org/https://github.com/eko/pihole-exporter/?tab=readme-ov-file#available-cli-options
...
type=update bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/pihole-exporter.sh)"
UPDATEEOF
