...
# Source: https://gh-proxy.org/https://github.com/hansmi/prometheus-paperless-exporter
...
function install() {
  ...
  cat <<EOF >"$CONFIG_PATH"
# https://gh-proxy.org/https://github.com/hansmi/prometheus-paperless-exporter
...
type=update bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/prometheus-paperless-ngx-exporter.sh)"
UPDATEEOF
