...
#
# bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/tools/pve/cron-update-lxcs.sh)"

set -euo pipefail

REPO_URL="https://gh-proxy.org/https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main"
