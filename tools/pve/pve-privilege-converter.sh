...
# Author: MickLesk
# Adapted from onethree7 (https://gh-proxy.org/https://github.com/onethree7/proxmox-lxc-privilege-converter)
...
source <(curl -fsSL https://git.community-scripts.org/Catfish-Y/ProxmoxVE/raw/branch/main/misc/core.func)
