#!/usr/bin/env bash
source <(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/misc/build.func)
# Copyright (c) 2021-2026 tteck
# Author: tteck (tteckster)
# License: MIT | https://gh-proxy.org/https://github.com/Catfish-Y/ProxmoxVE/raw/main/LICENSE
# Source: https://www.zigbee2mqtt.io/ | Github: https://gh-proxy.org/https://github.com/Koenkk/zigbee2mqtt
...
function update_script() {
  ...
  if check_for_gh_release "Zigbee2MQTT" "Koenkk/zigbee2mqtt"; then
    NODE_VERSION="24" NODE_MODULE="pnpm@$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Koenkk/zigbee2mqtt/master/package.json | jq -r '.packageManager | split("@")[1]')" setup_nodejs
