...
ADDON_SCRIPT="https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/runtipi.sh)"
MIGRATION_EOF
