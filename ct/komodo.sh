...
ADDON_SCRIPT="https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/Catfish-Y/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
